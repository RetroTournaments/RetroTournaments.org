  ...
  return (
    <>
      ...
      <article className="prose max-w-3xl">
        ...
        <p>
            Retrotournaments.org is entirely ran by volunteers coordinating on our <a href="https://discord.gg/kpYYyw8B5P" className="link link-hover">Discord↗</a>, we rely on your <Link to="/support">support</Link> in order to develop these competitions and expand around the globe.

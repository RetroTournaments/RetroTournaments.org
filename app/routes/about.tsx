    ...
    <div className="flex flex-row items-center justify-center mx-auto p-4">
      <article className="prose max-w-3xl">
        ...
        <p>
          ...
          competitions provide incredible experiences and opportunities for our
          competitors while simultaneously working to preserve retro
          technologies for future generations. We are very early in this
          process, but with your support we hope to get there sooner rather than
          later. Thank you for joining us for this fun and wild ride!
        </p>
        <blockquote>
          <h3> Our Goal </h3>
        ...
        <p>
          Check out the <Link to="/support">support</Link> page and chip in with
          your time or experience! We are always looking for better ways to
          improve future events, consider{" "}

    ...
    <div className="flex flex-col items-center justify-center mx-auto p-4 w-full max-w-4xl">
      <div className="w-full">
        <article className="prose p-4 max-w-4xl">
          ...
          <p>
            This is the absolute best way to support the project and ensure that
            there are more events, more work to extend the software to
            additional games, better content surrounding the events, and more
            opportunities. All funds are used directly to further the project by
            paying for travel, equipment, and other expenses. Contributors who
            donate over $50 USD will be included in future vignettes like the

    ...
    <div className="hero pt-6">
      <div className="hero-content text-center">
        <div className="max-w-2xl">
          ...
          <p className="pt-6">
              Home of the <b><i>Simultaneous Time Attack</i></b>.
              A fresh new competitive speedrunning format where multiple runners compete on identical setups combined onto the <b><i>same screen</i></b>.
          </p>
        </div>
      </div>
    </div>
        ...
        <div className="flex gap-5 justify-center pt-4">
          <div>
            <span className="countdown font-mono text-4xl">
                <span id="countdown-days" style={{"--value":0}}>0</span>
            </span>
            &nbsp;days
          </div>
          <div>
            <span className="countdown font-mono text-4xl">
                <span id="countdown-hours" style={{"--value":0}}>0</span>
            </span>
            &nbsp;hours
          </div>
          <div>
            <span className="countdown font-mono text-4xl">
                <span id="countdown-minutes" style={{"--value":0}}>0</span>
            </span>
            &nbsp;minutes
          </div>
          <div>
            <span className="countdown font-mono text-4xl">
                <span id="countdown-seconds" style={{"--value":0}}>0</span>
            </span>
            &nbsp;seconds
          </div>
        </div>
